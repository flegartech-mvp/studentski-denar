...
## Routes / screens used
- `audit/screenshots/final-ready/StudentskiDenar/04-dashboard-real.png` → shown as `studentski-denar.app`
- Mobile: `audit/screenshots/final-ready/StudentskiDenar/03-mobile.png`
...
- `videos/01-instagram-reel.mp4` (6.5 MB)
- `videos/02-tiktok.mp4` (6.5 MB)
- `videos/03-youtube-short.mp4` (6.5 MB)
- `videos/04-linkedin-demo.mp4` (13.6 MB)
- `videos/05-x-demo.mp4` (9.8 MB)
- `videos/06-facebook-demo.mp4` (13.6 MB)
- `videos/07-github-readme-demo.mp4` (6.8 MB)
- `videos/08-portfolio-hero.mp4` (13.6 MB)
- `videos/gifs/github-readme-demo.gif` (5.8 MB)
...
**Screens/routes used:** Monthly dashboard + mobile view.
